    ...
    <div align="center" style="margin-top: 30px">
        <table>
            <tr>
                <td>职位名称：</td>
                <td>
                    <s:textfield id="jobName" name="sysJob.jobName" />
                    <!--//@tips 根据用户输入的name跳转到jobAction并进行指定变量的赋值，所以此处为sysJob.jobName（实际为一个ognl表达式）-->
            ...
            <tr>
                <td>职位描述：</td>
                <td>
                    <s:textarea cols="50" rows="10" name="sysJob.jobDesc" id="jobDesc" />
                    <font color="red" size="5">*</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <s:submit value="提交" method="save" cssStyle="height:30px;width:60px" />
                </td>
                <td>
                    <s:reset value="重置" cssStyle="height:30px;width:60px" />
                </td>
            </tr>
        </table>
    </div>
