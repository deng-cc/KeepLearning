...
public abstract class FrameworkServlet extends HttpServletBean {
	 ...
	 */
    //origin set contextConfigLocation（即web.xml中servlet的param-name）
    //origin DispatcherServlet和ApplicationContext联系 --> step3：setContextConfigLocation，装入spring-mvc.xml
	 ...
	 */
	@Override
    //origin initServletBean()，初始化Servlet
    //origin DispatcherServlet和ApplicationContext联系 --> step4.1：初始化容器
	protected final void initServletBean() throws ServletException {
		...
		try {
            //origin 初始化webApplicationContext
	 ...
	 * @see #setContextConfigLocation
	 */
    //origin DispatcherServlet和ApplicationContext联系 --> step4.1.1：初始化webApplicationContext
	 ...
	 * @see #refresh()
	 */
    //origin DispatcherServlet和ApplicationContext联系 --> step5：onRefresh
